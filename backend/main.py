...
async def generate_ai_description(data: AIGenerate):
    try:
        ...
        fallback_text = f"✨ [Generated by Backup System] Perfectly suited for engineering students! This {data.title} is in excellent condition, highly reliable, and ready to help you crush your college assignments."
